            ...
            <div className="hidden lg:flex lg:flex-1 flex-col justify-between p-12 xl:p-16" 
                ...
                <div className="space-y-4">
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
                        <div className="flex items-start gap-3">
                            <div className="w-8 h-8 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0 mt-1">
                                <Icon name="BarChart3" size={18} color="#10b981" />
                            </div>
                            <div>
                                <p className="text-white font-medium mb-1">Real-time Analytics</p>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
                        <div className="flex items-start gap-3">
                            <div className="w-8 h-8 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0 mt-1">
                                <Icon name="MapPin" size={18} color="#10b981" />
                            </div>
                            <div>
                                <p className="text-white font-medium mb-1">District-wise Data</p>
                                <p className="text-gray-400 text-sm">
                                    Monitor all Maharashtra districts at once.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <div className="text-center lg:text-left mb-8">
                        ...
                        <p className="text-gray-400">Join Greenergy environmental platform.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Icon name="Building2" size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" />
                                <input
                                    type="text"
                                    required
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3.5 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6"
