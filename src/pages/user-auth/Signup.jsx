        ...
        <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "linear-gradient(135deg, #0d1a0d 0%, #051005 100%)" }}>
            <div className="w-full max-w-md bg-card rounded-2xl border p-8 shadow-2xl animate-fade-in" style={{ borderColor: "var(--color-border)", background: "rgba(15,31,15,0.8)", backdropFilter: "blur(12px)" }}>
                <div className="text-center mb-8">
                    ...
                    <p className="font-caption text-sm text-muted-foreground mt-2">Join Greenergy environmental platform</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        <label className="font-caption text-xs font-semibold uppercase tracking-wider text-muted-foreground ml-1">Full Name</label>
                        <div className="relative group">
                            <Icon name="User" size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" />
                            <input
                    ...
                    <div className="space-y-2">
                        <label className="font-caption text-xs font-semibold uppercase tracking-wider text-muted-foreground ml-1">Organization / Role</label>
                        <div className="relative group">
                            <Icon name="Globe" size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" />
                            <input
                                type="text" required placeholder="Environment Dept."
                                className="w-full bg-muted border border-border rounded-xl px-10 py-3 text-sm outline-none transition-all focus:border-primary/50 focus:ring-1 focus:ring-primary/20"
                    ...
                    <button
                        ...
                        className="w-full bg-primary text-primary-foreground font-semibold py-3 rounded-xl transition-all hover:opacity-90 active:scale-[0.98] mt-4 flex items-center justify-center gap-2"
                    >
